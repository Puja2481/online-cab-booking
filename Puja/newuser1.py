...
class Newuser(object):
    ...
    def __init__(self, root):
        self._images.append(tkinter.PhotoImage('new_user.gif', file = os.path.dirname(__file__) + '/new_user.gif'))
        ...
        self.userid = tkinter.Entry(self._frame_2,
            background = "#ffffff",
            width = 50,
        )
        self.password = tkinter.Entry(self._frame_3,
            width = 50,
            show="*"
        )
        self._label_5 = tkinter.Label(root,
            ...
            foreground = "#ffffff",
            text = u"\u26A0\uFE0F   Provide correct details to create an account",
        )
        ...
        self.cpassword = tkinter.Entry(self._frame_4,
            width = 50,
            show="*"
        )
        self._label_7 = tkinter.Label(root,
            activebackground = "#ffff9f",
            background = "#ffff9f",
            font = "{MS Sans Serif} 8 bold",
        ...
        self.name = tkinter.Entry(self._frame_1,
            background = "#ffffff",
            width = 50,
        )
...
class CustomNewuser(Newuser):
    ...
    def ok_command(self):
        try:
            ...
            messagebox.showerror("Error", "Something went wrong..!!!\nPlease contact Admin: +917973277319")
        pass
